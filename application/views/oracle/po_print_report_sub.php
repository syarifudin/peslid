   ...
   <body>
	<?php
			...
			foreach ($data_po_print as $row);
				...
				if ($data_deliv == "pas"){
					$delivery = "Jl. Rembang Industri Raya 47 PIER, Pasuruan 67152 - Indonesia";
				}
				else if ($data_deliv == "bog"){
					$delivery = "Kawasan Industri Menara Permai Jl. Raya Narogong KM 23.8 Cileungsi Bogor 16820 Jawa Barat - Indonesia";
				}
				else if ($data_deliv == "dks"){
					$delivery = "Dwikarya Sejahtera, PT | Jl. Tekno 3 Blok E3G, Kawasan Industri JABABEKA Tahap 3";
				}
				else if ($data_deliv == "din"){
					$delivery = "Dinito Jaya Sakti, PT | Jl. Raya Narogong, KM.28 Blok C 6-7-8 Kembang Kuning, Klapa Nunggal Cielungsi Bogor 16820 Indonesia";
				}
				else if ($data_deliv == "ori"){
					$delivery = "Oriental Plastic, PT | Jl. Industri Selatan 8 KWSN Industri JABABEKA Blok EE No.6A, Cikarang Selatan - Bekasi";
				}
				if ($data_term == "lcl"){
					$terms = "SEA by LCL";
				}
				else if ($data_term == "fcl"){
					$terms = "SEA by FCL";
				}
				else {
					$terms = $row['SHIP_VIA_LOOKUP_CODE'];
				}
				...
				?>
					...
					<tr>
					<?php if($cname=='a'){ ?>
						<td colspan="2"><div><font size="3" face="Arial">PT Panasonic Gobel Eco Solutions Manufacturing Indonesia</font></div><td>
					<?php } else {?>
					...
					<tr>
						<td colspan="2"><div align="center"><font size="3" face="Calibri"><b><u>PURCHASE ORDER (SUBCONT)</u></b></font></div><td>
					</tr>
					</table>
				<?php
					if ($row['BUYER'] == 454){$buyer_name = 'Mery Nurma Chanifah';} 
			...
			?>
					...
					<tr>
						<td>Supplier Code</td><td>: <?=$row['SUPPLIER'];?></td><td>Order No.</td><td>:</td>
					</tr>
					<tr>
					...
					<tr>
						<td>Delivery To</td><td rowspan="3" valign="top">: <?=$delivery;?></td><td valign="top">Currency</td><td valign="top">: <?=$row['CURRENCY_CODE'];?></td>
					</tr>
					<tr>
					...
					<thead>
					<tr>
						<th><div><font size="1" face="Calibri" color="#A9A9A9"></font><div>PO Number</th>
						<th>Model Number</th>
					...
					<?php
						foreach ($data_po_detail as $detail)
						{
								...
								echo "<tr height=30px>
								<td align='right'>$detail[PO_NUM]</td>
							...
							$pph_amount = $sum_amt * $pph ;
							$grand = $sum_amt + $tax_amount+$pph_amount ;
					?>
					<tr>
						<th></th>
						<th></th>
						<th colspan="6"><div align="right">Total Amount:</div></th>
					...
					<tr>
						...
						<td><div align="right"><b><?=number_format($pph_amount,2,'.',',');?></b></div></td>
					</tr>
					<tr>
		...
		<table cellpadding="1" cellspacing="0">
         <tr>
			<th width="69%"></th>
            <th>PT. Panasonic Gobel Life Solutions</br>Manufacturing Indonesia</br></br></br>__________________________</th>	
         </tr>
		</table>
		</br>
		</p>
