...
<body>
<table >
<tr><td style="margin-left: auto; font-size:18;margin-right: auto;font-weight:bold;">PT. PANASONIC GOBEL LIFE SOLUTIONS MANUFACTURING INDONESIA
</td><td></td><td></td></tr>
</table>
<hr>
<table>
...
echo "<span style='  font-weight: bold;    margin-left: 41%;'>PRODUCTION ORDER (NEW)</span>";
 }?>
<br><br>
...
?>
 ...
 <tr><td class='tebal'>PO NUMBER</td><td> <?=$po_number;?> </td><td>PROIRITY</td><td>  </td> </tr>
 ...
 <tr><td>OORDERER</td><td> (00038274) PT. PANASONIC GOBEL ECO SOLUTIONS MANUFACTURING INDONESIA
</td><td></td><td> </td> </tr>
 <tr><td>ACCOUNTEE</td><td> (00038274) PT. PANASONIC GOBEL ECO SOLUTIONS MANUFACTURING INDONESIA</td><td>DELIVERY DATE</td><td> <?=$dlvy;?>  </td> </tr>
...
$this->load->database();
			echo "<table border='1'>";
						...
						$query = $this->db->query("select * from open_po,open_po_detil 
											...
											and open_po_detil.kode_suplier='$vendor' and open_po.stat_po='open' and  open_po_detil.stat_po_='open'");
...
<br>
<span class='tebal'>REVISION REMARKS :</span><br>
<?php if(isset($rows['rev_remark'])) echo $rows['rev_remark'];  ?>
<br>
<br>
