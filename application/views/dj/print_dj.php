...
<?php
$item=$row->SEGMENT1;
$query = $this->db->query("select a.c_item,a.op_unit, a.c_item_desc,a.c_uom,qty_com,a.supply_subinventory,a.source_subinventory,fix.product_location_alt,b.item_number,b.on_hand_qty,b.SUBINVENTORY_CODE from 
	...
	?>
		      <tbody> 
					...
					<td><?php   echo $no++ ?></td> 
						...
						<td><?php   echo $row['on_hand_qty']?></td> 																												
...
?>
			...
			<tr> 
				<th colspan="6">Receiver (Approve By Manager)</th>
				<th></th>
				<th></th>
				<th></th>
				<th></th>
